...
@use '@angular/cdk/text-field-prebuilt.css'; @use 'portal-ui-ng/assets/base';
@use 'portal-ui-ng/assets/components';
@use 'portal-ui-ng/assets/pages'; @tailwind base;
@tailwind components;
