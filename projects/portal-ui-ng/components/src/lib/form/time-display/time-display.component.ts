...
export const TIME_DISPLAY_FORMATTER = new InjectionToken<TimeDisplayFormatter>(
  'TIME_DISPLAY_FORMATTER',
);
...
export class TimeDisplayComponent {
  ...
  _date = input.required<Date | string | number | null | undefined>({
    alias: 'date',
  });
