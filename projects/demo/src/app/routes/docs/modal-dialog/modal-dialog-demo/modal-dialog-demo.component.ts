...
@Component({
  ...
  imports: [ButtonModule, DividerComponent],
...
export class ModalDialogDemoComponent {
  ...
  openTitleText(isDialog = false) {
    const ref = this.modalDialog.open({
      ...
      details:
        'Ad dolore laboris minim quis aliqua. Aliqua ex quis dolore ut et et sint sunt consectetur. Nisi pariatur sit ullamco proident amet Lorem. Aliqua duis elit occaecat et laboris magna sint velit deserunt ad sunt id.',
      actions: isDialog
        ? [
            {
              label: 'Confirm',
  ...
  openTitleIconText(isDialog = false) {
    const ref = this.modalDialog.open({
      ...
      icon: 'block',
      details:
        'Ut exercitation consequat nisi ipsum cillum ad anim esse sint non excepteur consectetur sint. Enim ea veniam reprehenderit dolore eu quis sunt cupidatat proident qui culpa ipsum aliqua eiusmod. Est anim cupidatat proident fugiat deserunt pariatur.',
      actions: isDialog
        ? [
            {
              label: 'Cancel',
